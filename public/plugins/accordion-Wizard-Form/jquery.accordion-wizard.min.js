	...
	a.extend(c.prototype, {
		init: function() {
			...
			this.$steps = a("[data-acc-step]"), this.stepHeight = a("[data-acc-step]").eq(0).outerHeight(), this.settings.stepNumbers && this.$steps.each(function(t, e) {
				...
				if (0 < t && s.append('<a href="#" class="' + i.settings.autoButtonsPrevClass + '" data-acc-btn-prev>Back</a>'), t < i.$steps.length - 1) s.append('<a href="#" class="' + i.settings.autoButtonsNextClass + '" data-acc-btn-next>Next</a>');
