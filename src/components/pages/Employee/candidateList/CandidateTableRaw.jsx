  ...
  return (
    <>
      <tr className="border-bottom border-top">
        ...
        <td>
          {/* <button> */}
          <svg style={{ cursor: "pointer", display: candidate.nik ? "block" : "none" }} onClick={handleIconClick} xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
            <path
