    ...
    <>
      <tr className="border-bottom border-top">
        ...
        <td>
          ...
          {/* <button> */}
          <svg style={{ cursor: "pointer", display: dataLocal.employeeDetail ? "block" : "none" }} onClick={handleDetailClick} xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="24" height="24" viewBox="0 0 24 24">
          ...
          {/* <button> */}
          <svg style={{ cursor: "pointer", display: dataLocal.employeeUpdate ? "block" : "none" }} onClick={handleEditClick} xmlns="http://www.w3.org/2000/svg" className="side-menu__icon ms-3" width="24" height="24" viewBox="0 0 24 24">
            <path
