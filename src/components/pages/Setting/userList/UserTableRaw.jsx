  ...
  return (
    <>
      <tr className="border-top border-bottom">
        ...
        <td>
          <svg style={{ cursor: "pointer", display: dataLocal.userUpdate ? "block" : "none" }} onClick={handleEditClick} xmlns="http://www.w3.org/2000/svg" className="side-menu__icon ms-3" width="24" height="24" viewBox="0 0 24 24">
            <path
