...
export default function Row({ fee, index }) {
  ...
  return (
      <tr className="border-bottom border-top">
        ...
        <td>
          <svg style={{ cursor: "pointer", display: dataLocal.feeDetail ? "" : "none" }} onClick={handleDetailClick} xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="24" height="24" viewBox="0 0 24 24">
