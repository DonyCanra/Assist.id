...
import AddEmployeeBulk from "../pages/Employee/addEmployee/AddEmployeeDataBulk";
import EditEmployee from "../pages/Employee/editEmployee/EditEmployee";
import Candidate from "../pages/Employee/candidateList/Candidate";
import DetailEmployee from "../pages/Employee/detailEmployee/DetailEmployee";
import Fee from "../pages/Fee/Fee";
import DetailFee from "../pages/Fee/detailFee/DetailFee";
import UserList from "../pages/Setting/userList/User";
import AddUser from "../pages/Setting/addUser/AddUser";
import EditUser from "../pages/Setting/editUser/EditUser";
import Role from "../pages/Setting/role/Role";
import AddRole from "../pages/Setting/addRole/AddRole";
import EditRole from "../pages/Setting/editRole/EditRole";
